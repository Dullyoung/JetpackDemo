package com.dullyoung.baselib.utils;
...
public class LogUtil {
    ...
    public static void e(StackTraceElement[] stackTraceElements, Object... msg) {
        ...
        for (StackTraceElement stackTraceElement : stackTraceElements) {
            if (stackTraceElement.getClassName().startsWith(ActivityUtils.getTopActivity().getPackageName()) &&
                    !stackTraceElement.getClassName().startsWith(ActivityUtils.getTopActivity().getPackageName() + ".base")) {
